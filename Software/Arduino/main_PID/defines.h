...
const char* ssid      = "eppl";       //Enter SSID
const char* password  = "wedoresearch";   //Enter Password

//const char* websockets_server_host = "127.0.0.1"; //Enter server address
const char* websockets_server_host = "192.168.0.106"; //Enter server address

#define WEBSOCKETS_PORT     5678
